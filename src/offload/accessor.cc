...
void const *GenericTensorAccessorR::get_void_ptr() const { return ptr; }
...
void *GenericTensorAccessorW::get_void_ptr() const { return ptr; }
...
GenericTensorAccessorR helperGetGenericTensorAccessorRO(
  ...
  case DT_FLOAT_COMPLEX: {
    ptr = helperGetTensorPointerRO<cuFloatComplex>(region, req, fid, ctx,
                                                   runtime);
    break;
  }
  case DT_DOUBLE_COMPLEX: {
    ptr = helperGetTensorPointerRO<cuDoubleComplex>(region, req, fid, ctx,
                                                    runtime);
    break;
  }
  default: {
...
GenericTensorAccessorW helperGetGenericTensorAccessorWO(
  ...
  case DT_FLOAT_COMPLEX: {
    ptr = helperGetTensorPointerWO<cuFloatComplex>(region, req, fid, ctx,
                                                   runtime);
    break;
  }
  case DT_DOUBLE_COMPLEX: {
    ptr = helperGetTensorPointerWO<cuDoubleComplex>(region, req, fid, ctx,
                                                    runtime);
    break;
  }
  default: {
...
GenericTensorAccessorW helperGetGenericTensorAccessorRW(
  ...
  case DT_FLOAT_COMPLEX: {
    ptr = helperGetTensorPointerRW<cuFloatComplex>(region, req, fid, ctx,
                                                   runtime);
    break;
  }
  case DT_DOUBLE_COMPLEX: {
    ptr = helperGetTensorPointerRW<cuDoubleComplex>(region, req, fid, ctx,
                                                    runtime);
    break;
  }
  default: {
