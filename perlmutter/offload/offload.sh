...
#  ../../build/examples/legion-based/test -ll:gpu $gpu -ll:cpu $gpu -ll:fsize 38000 -ll:zsize 100000 --local-qubits 28 --all-qubits 31 --circuit qft >logs/offload_${gpu}_31.log
  ../../build/examples/legion-based/test -ll:gpu $gpu -ll:cpu $gpu -ll:fsize 38000 -ll:zsize 200000 --local-qubits 28 --all-qubits 32 --circuit dj >logs/offload_dj_${gpu}_32.log
  ../../build/examples/legion-based/test -ll:gpu $gpu -ll:cpu $gpu -ll:fsize 38000 -ll:zsize 200000 --local-qubits 28 --all-qubits 32 --circuit wstate >logs/offload_wstate_${gpu}_32.log
done
