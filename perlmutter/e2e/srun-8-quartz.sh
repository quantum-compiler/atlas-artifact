...
for str in "${strings[@]}"; do
    ...
    srun -u \
         ...
         --ntasks-per-node=1\
         /pscratch/sd/z/zjia/qs/torque/build2/examples/mpi-based/simulate --import-circuit ${str} --n 33 --local 28 --device 4 --use-ilp > /pscratch/sd/z/zjia/qs/result-srun/torque-rerun/${str}_33.log
done